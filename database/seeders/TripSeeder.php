    ...
    public function run(): void
    {
        $trips = [
            [
                ...
                'flag' => '<img src="{{ asset(\'img/flags/f_arg.png\') }}" width="auto" height="25" class="me-1 my-1 shadow" alt="Flag of Argentina">
            ...
            [
                ...
                'flag' => '<img src="{{ asset(\'img/flags/f_indo.png\') }}" width="auto" height="25" class="mx-1 shadow" alt="Flag of Indonesia">',
                'trip_name' => 'W świecie kontrastów',
                'country' => 'Indonezja'
            ],
            [
                'destination' => 'Kambodża',
                'flag' => '<img src="{{ asset(\'img/flags/f_cam.png\') }}" width="auto" height="25" class="me-1 my-1 shadow" alt="Flag of Cambodia">',
                'trip_name' => 'Królestwo w dżungli',
                'country' => 'Kambodża'
            ],
            [
                'destination' => 'Peru i Boliwia',
                'flag' => '<img src="{{ asset(\'img/flags/f_peru.png\') }}" width="auto" height="25" class="me-1 my-1 shadow" alt="Flag of Peru">
            ...
            [
                ...
                'flag' => '<img src="{{ asset(\'img/flags/f_sri.png\') }}" width="auto" height="25" class="me-1 my-1 shadow" alt="Flag of Sri Lanka">',
                'trip_name' => 'Budda, herbata i słonie',
                'country' => 'Sri Lanka'
            ],
            [
                'destination' => 'Tybet, w Chinach',
                'flag' => '<img src="{{ asset(\'img/flags/f_tib.png\') }}" width="auto" height="25" class="me-1 my-1 shadow" alt="Flag of Tibet">
