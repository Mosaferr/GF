	...
	<main class="custom-margin-top">
			...
			<div class="row ">
				<div class="col-md-12 text-center pb-5 mt-3">
					<h1><img src="img/logo_black.svg" width="35" height="auto" class="d-inline-block ms-sm-4 align-text-top" alt="logo"> Glob<i>Frotter</i>.pl</h1>
				</div>
			</div>
			<div class="row ">
